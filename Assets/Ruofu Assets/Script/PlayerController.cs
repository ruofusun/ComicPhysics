...
*/
    ...
    void FixedUpdate()
    {
        ...
        RaycastHit2D hitPropsLeft= Physics2D.Raycast(transform.position-transform.up* colliderRadiusY, -transform.right, 1.5f, 1 << LayerMask.NameToLayer("Props"));
        RaycastHit2D hitPropsRight= Physics2D.Raycast(transform.position-transform.up* colliderRadiusY, transform.right, 1.5f, 1 << LayerMask.NameToLayer("Props"));
      ...
      //  Debug.DrawLine(groundCheckPos, groundCheckPos - new Vector3(0, colliderRadiusX, 0), isGrounded ? Color.green : Color.red);
        Debug.DrawLine(transform.position-transform.up* colliderRadiusY, transform.position-transform.up* colliderRadiusY+transform.right*1.5f, isGrounded ? Color.green : Color.red);
        Debug.DrawLine(transform.position-transform.up* colliderRadiusY, transform.position-transform.up* colliderRadiusY-transform.right*1.5f, isGrounded ? Color.cyan : Color.yellow);
    }
}
